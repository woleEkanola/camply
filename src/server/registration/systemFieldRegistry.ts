...
const CAMPER: SystemFieldDefinition[] = [
  ...
  field({ systemKey: "parentPhone", label: "Parent/Guardian Phone", type: "TEXT", required: false, visible: true, sortOrder: 50, groupLabel: "Contact Details" }),
  field({ systemKey: "teenPhone", label: "Teen Phone Number", type: "TEXT", required: false, visible: true, sortOrder: 52, groupLabel: "Contact Details" }),
  field({ systemKey: "homeAddressStreet", label: "Street Address", type: "TEXT", required: false, visible: true, sortOrder: 54, groupLabel: "Contact Details" }),
  field({ systemKey: "homeAddressCity", label: "City", type: "TEXT", required: false, visible: true, sortOrder: 55, groupLabel: "Contact Details" }),
  field({ systemKey: "homeAddressState", label: "State", type: "TEXT", required: false, visible: true, sortOrder: 56, groupLabel: "Contact Details" }),
  field({ systemKey: "homeAddressZip", label: "ZIP Code", type: "TEXT", required: false, visible: true, sortOrder: 57, groupLabel: "Contact Details" }),
