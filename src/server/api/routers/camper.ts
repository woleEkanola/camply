    ...
    .mutation(async ({ ctx, input }) => {
      ...
      const updatedProfile = await ctx.prisma.camper.update({
        ...
        data: {
          ...
          ...(input.profile.preferredName !== undefined && { preferredName: input.profile.preferredName }),
          ...(input.profile.photoUrl !== undefined && { photoUrl: input.profile.photoUrl }),
          ...(input.profile.allergies !== undefined && { allergies: input.profile.allergies }),
          ...(input.profile.medicalConditions !== undefined && { medicalConditions: input.profile.medicalConditions }),
          ...(input.profile.medications !== undefined && { medications: input.profile.medications }),
          ...(input.profile.dietaryRestrictions !== undefined && { dietaryRestrictions: input.profile.dietaryRestrictions }),
          ...(input.profile.emergencyContactName !== undefined && { emergencyContactName: input.profile.emergencyContactName }),
          ...(input.profile.emergencyContactPhone !== undefined && { emergencyContactPhone: input.profile.emergencyContactPhone }),
          ...(input.profile.relationship !== undefined && { relationship: input.profile.relationship }),
          ...(input.profile.parentPhone !== undefined && { parentPhone: input.profile.parentPhone }),
          ...(input.profile.teenPhone !== undefined && { teenPhone: input.profile.teenPhone }),
          ...(input.profile.homeAddressStreet !== undefined && { homeAddressStreet: input.profile.homeAddressStreet }),
          ...(input.profile.homeAddressCity !== undefined && { homeAddressCity: input.profile.homeAddressCity }),
          ...(input.profile.homeAddressState !== undefined && { homeAddressState: input.profile.homeAddressState }),
          ...(input.profile.homeAddressZip !== undefined && { homeAddressZip: input.profile.homeAddressZip }),
          ...(input.profile.school !== undefined && { school: input.profile.school }),
          ...(input.profile.currentClass !== undefined && { currentClass: input.profile.currentClass }),
          ...(input.profile.church !== undefined && { church: input.profile.church }),
          ...(input.profile.pastor !== undefined && { pastor: input.profile.pastor }),
        }
      });
