  ...
  return (
    <AppShell area="volunteer">
      <div className="mx-auto max-w-4xl space-y-8">
        <PageHeader
          title="Volunteer Documents & Downloads"
          description="Access volunteer guides, department handbooks, schedules, rules, and your official Staff ID Card."
        />
        ...
        {/* ── Section 2: Volunteer Resources & Camp Guides ── */}
        <div className="space-y-4">
          <div className="flex items-center gap-2">
          ...
          {isResourcesLoading ? (
            ...
            <div className="rounded-2xl border border-dashed border-border-default bg-surface p-6 text-center text-sm text-txt-muted">
              No volunteer documents or handbooks published yet for this camp.
            </div>
          ) : (
