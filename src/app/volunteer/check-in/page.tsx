          ...
          if (profile.volunteerCategory !== "Registration") {
            return (
              <div className="max-w-md mx-auto mt-10 text-center space-y-2">
                ...
                <p className="text-sm text-neutral-500">Check-in is only available to Registration department volunteers.</p>
              </div>
            );
          }
          return <ScanCenterShell organizationId={organizationId} defaultStationId="CAMP_ARRIVAL" />;
        }}
      </StaffGate>
    </AppShell>
  );
