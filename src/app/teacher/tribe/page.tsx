...
export default function TeacherTribePage() {
  ...
  return <AppShell area="teacher"><PageHeader title="My Tribe" description="Your tribe roster, attendance and points hub." />
