      ...
      <div className="mx-auto mt-6 w-full max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="rounded-lg bg-white p-6 shadow">
          ...
          <div className="mt-2 grid grid-cols-1 gap-4 sm:grid-cols-2">
            <div>
              <p className="text-sm text-orange-500">Your Role:</p>
              <p className="font-medium text-gray-900">{session?.user?.role}</p>
            </div>
            <div>
              <p className="text-sm text-orange-500">Organization ID:</p>
            ...
            <Link
              ...
              className={`inline-flex items-center border-b-2 py-4 px-1 text-sm font-medium ${
                activeTab === "locations"
                  ...
                  : "border-transparent text-orange-500 hover:border-gray-300 hover:text-orange-700"
              }`}
            >
