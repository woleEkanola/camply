    ...
    <AppShell area="admin">
      <div className="mx-auto max-w-6xl space-y-6">
        ...
        <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-5">
          <div className="rounded-lg bg-neutral-50 p-4 text-center"><div className="text-2xl font-bold text-neutral-900">{overview?.totalSent ?? 0}</div><div className="text-xs text-neutral-500">Sent</div></div>
        ...
        <Card>
          <CardBody>
            <p className="text-sm font-medium text-neutral-700 mb-3">Daily Activity (30 days)</p>
            <div className="space-y-1">
              {timeSeries?.map((day: any) => (
                <div key={day.date} className="flex items-center gap-2 text-xs">
                  <span className="w-24 text-neutral-500">{day.date}</span>
