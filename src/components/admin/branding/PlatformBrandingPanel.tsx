...
/**
 * Super Admin-only platform branding controls (logos, favicon/PWA icons,
 * default email logo, theme colors). Shared between the standalone
 * /super-admin/branding route and the Branding tab on the Super Admin
 * Dashboard so both stay in sync with a single implementation.
 */
